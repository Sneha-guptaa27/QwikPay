  ...
  return (
      <div className="w-[350px] h-[500px] bg-gradient-to-r from-primary to-third  mt-[10px] ml-[40px] rounded-2xl border-2 border-third">
          <div className='flex flex-col justify-items-center'>
              ...
              <div className='flex justify-center p-[25px] '><button className='h-[60px] w-[200px] border-2 bg-primary rounded-2xl font-bold' onClick={()=>navigate('/split')}>GET STARTED</button></div>
          </div>
